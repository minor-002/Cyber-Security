...
Control name	Control type and explanation	Needs to be implemented
(X)	Priority
...
Encryption
	Deterrent; makes confidential information/data more secure (i.e., website payment transactions)	X	High/
Medium
